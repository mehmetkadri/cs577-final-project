...
def inception_block_1a(X):
    ...
    # CONCAT
    inception = merge([X_3x3, X_5x5, X_pool, X_1x1], mode='concat', concat_axis=1)
...
def inception_block_1c(X):
    ...
    inception = merge([X_3x3, X_5x5, X_pool], mode='concat', concat_axis=1)
...
def inception_block_3a(X):
    ...
    inception = merge([X_3x3, X_pool, X_1x1], mode='concat', concat_axis=1)
